    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Out\Miguel\Miguel-Profile.webp" alt="Miguel" title='Miguel' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Swiftness-Trait.webp" alt="Swiftness" title='Swiftness'></img>
                <h1>Swiftness :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Brutal-Kick.webp" alt="Brutal Kick" title='Brutal Kick'></img>
                <h1>Brutal Kick :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Healers-Bane.webp" alt="Healer’s Bane" title='Healer’s Bane'></img>
                <h1>Healer’s Bane :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Intuition.webp" alt="Intuition" title='Intuition'></img>
                <h1>Intuition :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Flaming-Shot.webp" alt="Flaming Shot" title='Flaming Shot'></img>
                <h1>Flaming Shot :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Bounty-Hunting.webp" alt="Bounty Hunting" title='Bounty Hunting'></img>
                <h1>Bounty Hunting :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Protective-Razor.webp" alt="Protective Razor" title='Protective Razor'></img>
                <h1>Protective Razor :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Highland-Advantage.webp" alt="Highland Advantage" title='Highland Advantage'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Blinding-Powder.webp" alt="Blinding Powder" title='Blinding Powder'></img>
                <h1>Blinding Powder :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\World-Drifter.webp" alt="World Drifter" title='World Drifter'></img>
                <h1>World Drifter :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Filthy-Blade.webp" alt="Filthy Blade" title='Filthy Blade'></img>
                <h1>Filthy Blade :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Fire-Bomb.webp" alt="Fire Bomb" title='Fire Bomb'></img>
                <h1>Fire Bomb :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Place-Trap.webp" alt="Place Trap" title='Place Trap'></img>
                <h1>Place Trap :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Miguel\Mourner.webp" alt="Mourner" title='Mourner'></img>
                <h1>Mourner :
