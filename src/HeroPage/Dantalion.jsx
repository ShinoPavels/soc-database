    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Dantalion\Dantalion-Profile.webp" alt="Dantalion" title='Dantalion' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Path-to-Kingship-Trait.webp" alt="Path to Kingship" title='Path to Kingship'></img>
                <h1>Path to Kingship :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Dawnlight.webp" alt="Dawnlight" title='Dawnlight'></img>
                <h1>Dawnlight :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Inspired-Healing.webp" alt="Inspired Healing" title='Inspired Healing'></img>
                <h1>Inspired Healing :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Unsheathe.webp" alt="Unsheathe" title='Unsheathe'></img>
                <h1>Unsheathe :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Daybreak.webp" alt="Daybreak" title='Daybreak'></img>
                <h1>Daybreak :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\NRG-Depleting-Blow.webp" alt="NRG-Depleting Blow" title='NRG-Depleting Blow'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Air-of-Royalty.webp" alt="Air of Royalty" title='Air of Royalty'></img>
                <h1>Air of Royalty :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Tenacity.webp" alt="Tenacity" title='Tenacity'></img>
                <h1>Tenacity :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Destructive-Storm.webp" alt="Destructive Storm" title='Destructive Storm'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\For-Iria!.webp" alt="For Iria!" title='For Iria!'></img>
                <h1>For Iria! :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\White-Sword.webp" alt="White Sword" title='White Sword'></img>
                <h1>White Sword :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Shield-break-Attack.webp" alt="Shield-break Attack" title='Shield-break Attack'></img>
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Legacy-of-Comrades.webp" alt="Legacy of Comrades" title='Legacy of Comrades'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Dantalion\Endless-Dawn.webp" alt="Endless-Dawn" title='Endless-Dawn'></img>
                <h1>Endless-Dawn :
