    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Inc\Safiyyah\Safiyyah-Profile.webp" alt="Safiyyah" title='Safiyyah' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Rose-with-Thorns-Trait.webp" alt="Rose with Thorns" title='Rose with Thorns'></img>
                <h1>Rose with Thorns :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Hunting-Impluse.webp" alt="Hunting Impulse" title='Hunting Impulse'></img>
                <h1>Hunting Impulse :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Settlement-of-the-Hanged-Man.webp" alt="Settlement of the Hanged Men" title='Settlement of the Hanged Men'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Shadow-Raid.webp" alt="Shadow Raid" title='Shadow Raid'></img>
                <h1>Shadow Raid :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Shadowless-Blade.webp" alt="Shadowless Blade" title='Shadowless Blade'></img>
                <h1>Shadowless Blade :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Tactical-Adjustment.webp" alt="Tactical Adjustment" title='Tactical Adjustment'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Shadow-Blade-Pursuit.webp" alt="Shadow Blade Pursuit" title='Shadow Blade Pursuit'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Emergency-Hedging.webp" alt="Emergency Hedging" title='Emergency Hedging'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Order-to-Kill-traitors.webp" alt="Order to Kill traitors" title='Order to Kill traitors'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\The-Hanged-Man-Commander.webp" alt="The Hanged Man Commander" title='The Hanged Man Commander'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Seal-Strike.webp" alt="Seal Strike" title='Seal Strike'></img>
                <h1>Seal Strike :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Linked-Attack.webp" alt="Linked Attack" title='Linked Attack'></img>
                <h1>Linked Attack :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Breaking-Blade.webp" alt="Breaker Blade" title='Breaker Blade'></img>
                <h1>Breaker Blade :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Safiyyah\Corrosion-Weapons.webp" alt="Corrosion Weapons" title='Corrosion Weapons'></img>
