    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Inc\Taair\Taair-Profile.webp" alt="Taair" title='Taair' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Historian-Trait.webp" alt="Historian" title='Historian'></img>
                <h1>Historian :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Treatment.webp" alt="Treatment" title='Healing'></img>
                <h1>Treatment :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Seeds-of-Knowledge.webp" alt="Seeds of Knowledge" title='Seeds of Knowledge'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Good-news-from-a-far.webp" alt="Good news from a far" title='Good news from a far'></img>
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Heal.webp" alt="Heal" title='Heal'></img>
                <h1>Heal :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Light-of-the-Soul.webp" alt="Light of the Soul" title='Light of the Soul'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Pacifism.webp" alt="Pacifism" title='Pacifism'></img>
                <h1>Pacifism :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\The-Heart-of-Forbearance.webp" alt="The Heart of Forbearance" title='The Heart of Forbearance'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Bonfire-Night-Talk.webp" alt="Bonfire Night Talk" title='Bonfire Night Talk'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Ascetic.webp" alt="Ascetic" title='Ascetic'></img>
                <h1>Ascetic :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Kind-Heart-Strike.webp" alt="Kind Heart Strike" title='Kind Heart Strike'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Magic-Dispel.webp" alt="Magic Dispel" title='Magic Dispel'></img>
                <h1>Magic Dispel :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Lay-on-Hands.webp" alt="Lay on Hands" title='Lay on Hands'></img>
                <h1>Lay on Hands :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Taair\Dreaming-in-a-Cage.webp" alt="Dreaming in a Cage" title='Dreaming in a Cage'></img>
