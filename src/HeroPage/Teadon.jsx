    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Teadon\Teadon-Profile.webp" alt="Teadon" title='Teadon' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Battle-Tested-Shield-Trait.webp" alt="Battle Tested Shield" title='Battle Tested Shield'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Defensive-Stance.webp" alt="Defensive Stance" title='Defensive Stance'></img>
                <h1>Defensive Stance :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Intimidate.webp" alt="Intimidate" title='Intimidate'></img>
                <h1>Intimidate :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Knock-out-Blow.webp" alt="Knock-out Blow" title='Knock-out Blow'></img>
                <h1>Knock-out Blow :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Fierce-Assault.webp" alt="Fierce Assault" title='Fierce Assault'></img>
                <h1>Fierce Assault :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Hit-and-Run-Tactics.webp" alt="Hit-and-Run Tactics" title='Hit-and-Run Tactics'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Thick-Shield.webp" alt="Thick Shield" title='Thick Shield'></img>
                <h1>Thick Shield :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Counterattack.webp" alt="Counterattack" title='Counterattack'></img>
                <h1>Counterattack :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Array-Command.webp" alt="Array Command" title='Array Command'></img>
                <h1>Array Command :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Shield-of-Punishment.webp" alt="Shield of Punishment" title='Shield of Punishment'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Powerful-Attack.webp" alt="Powerful Attack" title='Powerful Attack'></img>
                <h1>Powerful Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Ice-Attack.webp" alt="Ice Attack" title='Ice Attack'></img>
                <h1>Ice Attack :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Impregnable-Shield.webp" alt="Impregnable Shield" title='Impregnable Shield'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Teadon\Will-to-Survive.webp" alt="Will to Survive" title='Will to Survive'></img>
                <h1>Will to Survive :
