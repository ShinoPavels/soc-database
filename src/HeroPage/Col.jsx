    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Col\Col-Profile.webp" alt="Col" title='Col' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Killer-Instinct-Trait.webp" alt="Killer Instinct" title='Killer Instinct'></img>
                <h1>Killer Instinct :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Flurry-of-Stabs.webp" alt="Flurry of Stabs" title='Flurry of Stabs'></img>
                <h1>Flurry of Stabs :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Ambush.webp" alt="Ambush" title='Ambush'></img>
                <h1>Ambush :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Shadow-Gait.webp" alt="Shadow Gait" title='Shadow Gait'></img>
                <h1>Shadow Gait :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Assault.webp" alt="Assault" title='Assault'></img>
                <h1>Assault :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Mask.webp" alt="Mask" title='Mask'></img>
                <h1>Mask :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Eerie-Footwork.webp" alt="Eerie Footwork" title='Eerie Footwork'></img>
                <h1>Eerie Footwork :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Counterattack.webp" alt="Counterattack" title='Counterattack'></img>
                <h1>Counterattack :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Perfect-Assassin.webp" alt="Perfect Assassin" title='Perfect Assassin'></img>
                <h1>Perfect Assassin :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Omen-of-Death.webp" alt="Omen of Death" title='Omen of Death'></img>
                <h1>Omen of Death :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Hidden-Thorn.webp" alt="Hidden Thorn" title='Hidden Thorn'></img>
                <h1>Hidden Thorn :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Critical-Strike.webp" alt="Critical Strike" title='Critical Strike'></img>
                <h1>Critical Strike :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Wipe-Out.webp" alt="Wipe Out" title='Wipe Out'></img>
                <h1>Wipe Out :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Col\Traceless-Shadows.webp" alt="Traceless Shadows" title='Traceless Shadows'></img>
