    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Night-Raven-Profile.webp" alt="Night-Raven" title='Night-Raven' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Mysterious-Will-Trait.webp" alt="Mysterious Will" title='Mysterious Will'></img>
                <h1>Mysterious Will :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Eroding-Darkness.webp" alt="Eroding Darkness" title='Eroding Darkness'></img>
                <h1>Eroding Darkness :
            ...
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Erosion.webp" alt="Erosion" title='Erosion'></img>
                <h1>Erosion :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Life-Devourer.webp" alt="Life Devourer" title='Life Devourer'></img>
                <h1>Life Devourer :
            ...
            <tr className='bg-gray-800  align left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Corruption.webp" alt="Corruption" title='Corruption'></img>
                <h1>Corruption :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Settlement-of-the-Hanged-Men.webp" alt="Settlement of the Hanged Men" title='Settlement of the Hanged Men'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Protection-of-Darkness.webp" alt="Protection of Darkness" title='Protection of Darkness'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Glare.webp" alt="Glare" title='Glare'></img>
                <h1>Glare :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Dark-Ripple.webp" alt="Dark Ripple" title='Dark Ripple'></img>
                <h1>Dark Ripple :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Darkest-Annihilation.webp" alt="Darkest Annihilation" title='Darkest Annihilation'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Hypnotic-Attack.webp" alt="Hypnotic Attack" title='Hypnotic Attack'></img>
                <h1>Hypnotic Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Night-Raven\Charged-Attack.webp" alt="Charged Attack" title='Charged Attack'></img>
                <h1>Charged Attack :
