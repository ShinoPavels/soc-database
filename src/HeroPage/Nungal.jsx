    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Nungal\Nungal-Profile.webp" alt="Nungal" title='Nungal' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Luxite-Crossbow-Trait.webp" alt="Luxite Crossbow" title='Luxite Crossbow'></img>
                <h1>Luxite Crossbow :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Powerful-Shot.webp" alt="Powerful Shot" title='Powerful Shot'></img>
                <h1>Powerful Shot :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Dharana.webp" alt="Dharana" title='Dharana'></img>
                <h1>Dharana :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Full-Draw.webp" alt="Full Draw" title='Full Draw'></img>
                <h1>Full Draw :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Deadly-Aim.webp" alt="Deadly Aim" title='Deadly Aim'></img>
                <h1>Deadly Aim :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Sniping-Stance.webp" alt="Sniping Stance" title='Sniping Stance'></img>
                <h1>Sniping Stance :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Snipers-Inuition.webp" alt="Sniper’s Intuition" title='Sniper’s Intuition'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Highland-Advantage.webp" alt="Highland Advantage" title='Highland Advantage'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Shattering-Arrow.webp" alt="Shattering Arrow" title='Shattering Arrow'></img>
                <h1>Shattering Arrow :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Sense-of-Purpose.webp" alt="Sense of Purpose" title='Sense of Purpose'></img>
                <h1>Sense of Purpose :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Fatal-Attack.webp" alt="Fatal Attack" title='Fatal Attack'></img>
                <h1>Fatal Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Marking-Bullet.webp" alt="Marking Bullet" title='Marking Bullet'></img>
                <h1>Marking Bullet :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Quick-Reload.webp" alt="Quick Reload" title='Quick Reload'></img>
                <h1>Quick Reload :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Nungal\Eagle-Eye.webp" alt="Eagle Eye" title='Eagle Eye'></img>
                <h1>Eagle Eye :
