          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Crossbow-Of-Blessing-Trait.webp" alt="Crossbow of Blessing" title='Crossbow of Blessing'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Knock-Back-Shot.webp" alt="Erosion" title='Erosion'></img>
                <h1>Erosion :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Flaming-Shot.webp" alt="Flaming Shot" title='Flaming Shot'></img>
                <h1>Flaming Shot :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Cover-Shoot.webp" alt="Cover Shoot" title='Cover Shoot'></img>
                <h1>Cover Shoot :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\The-Protected.webp" alt="The Protected" title='The Protected'></img>
                <h1>The Protected :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Light-of-Sanctuary.webp" alt="Light of Sanctuary" title='Light of Sanctuary'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Defense-AoE.webp" alt="Defense (AoE)" title='Defense (AoE)'></img>
                <h1>Defense (AoE) :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Strength-Activation.webp" alt="Strength Activation" title='Strength Activation'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Storm-Sniper.webp" alt="Storm Sniper" title='Storm Sniper'></img>
                <h1>Storm Sniper :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Crit-Command.webp" alt="Crit Command" title='Crit Command'></img>
                <h1>Crit Command :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Fatal-Attack.webp" alt="Fatal Attack" title='Fatal Attack'></img>
                <h1>Fatal Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Divine Grace\Critical-Strike.webp" alt="Invigorating Strike" title='Invigorating Strike'></img>
