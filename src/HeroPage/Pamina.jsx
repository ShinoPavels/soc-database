    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Inc\Pamina\Pamina-Profile.webp" alt="Pamina" title='Pamina' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\The-Flower-of-Fierceness-Trait.webp" alt="The Flower of Fierceness" title='The Flower of Fierceness'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Swift-Combo.webp" alt="Swift Combo" title='Swift Combo'></img>
                <h1>Swift Combo :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Breaking-Spear.webp" alt="Breaking Spear" title='Breaking Spear'></img>
                <h1>Breaking Spear :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Who-Can-Compete-With.webp" alt="Who Can Compete With" title='Who Can Compete With'></img>
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Chop.webp" alt="Chop" title='Chop'></img>
                <h1>Chop :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\The-Sturdy-Stance.webp" alt="The Sturdy Stance" title='The Sturdy Stance'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Righteousness.webp" alt="Righteousness" title='Righteousness'></img>
                <h1>Righteousness :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Front-Defense.webp" alt="Front Defense" title='Front Defense'></img>
                <h1>Front Defense :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Shield-Break.webp" alt="Shield Break" title='Shield Break'></img>
                <h1>Shield Break :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Breakthrough-Invincible.webp" alt="Breakthrough Invincible" title='Breakthrough Invincible'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Breaking-Lightning.webp" alt="Breaking Lightning" title='Breaking Lightning'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Powerful-Attack.webp" alt="Powerful Attack" title='Powerful Attack'></img>
                <h1>Powerful Attack :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\Counterattack-Storm.webp" alt="Counterattack-Storm" title='Counterattack-Storm'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Inc\Pamina\FireWire.webp" alt="FireWire" title='FireWire'></img>
                <h1>FireWire :
