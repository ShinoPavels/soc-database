    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Flame-Sorceress-Profile.webp" alt="Flame Sorceress" title='Flame Sorceress' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Flame-Sorceress-Trait.webp" alt="Flame Sorceress" title='Flame Sorceress'></img>
                <h1>Flame Sorceress :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Fireball.webp" alt="Fireball" title='Fireball'></img>
                <h1>Fireball :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Fire-Pillar.webp" alt="Fire Pillar" title='Fire Pillar'></img>
                <h1>Fire Pillar :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\High-Morale.webp" alt="High Morale" title='High Morale'></img>
                <h1>High Morale :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Blazing.webp" alt="Blazing" title='Blazing'></img>
                <h1>Blazing :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Wind-Rider.webp" alt="Wind Rider" title='Wind Rider'></img>
                <h1>Wind Rider :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Firewalking.webp" alt="Firewalking" title='Firewalking'></img>
                <h1>Firewalking :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Defense-Ranged-Attack.webp" alt="Defense (Ranged Attack)" title='Defense (Ranged Attack)'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Incinerating-Formation.webp" alt="Incinerating Formation" title='Incinerating Formation'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Pyroblast.webp" alt="Pyroblast" title='Pyroblast'></img>
                <h1>Pyroblast :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Charged-Attack.webp" alt="Charged Attack" title='Charged Attack'></img>
                <h1>Charged Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Flame-Sorceress\Scorching-Attack.webp" alt="Scorching Attack" title='Scorching Attack'></img>
                <h1>Scorching Attack :
