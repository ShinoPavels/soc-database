    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Candlelight-Profile.webp" alt="Candlelight" title='Candlelight' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Candlelight-Trait.webp" alt="Depression" title='Depression'></img>
                <h1>Depression :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Light-of-Judgment.webp" alt="Light of Judgment" title='Light of Judgment'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Soul-Soothing.webp" alt="Soul Soothing" title='Soul Soothing'></img>
                <h1>Soul Soothing :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\PDEF-Command.webp" alt="P. DEF Command" title='P. DEF Command'></img>
                <h1>P. DEF Command :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Potential-Stimulation.webp" alt="Potential Stimulation" title='Potential Stimulation'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Light-of-the-Heart.webp" alt="Light of the Heart" title='Light of the Heart'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Reluctantly.webp" alt="Reluctantly" title='Reluctantly'></img>
                <h1>Reluctantly :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Energy-Recovery.webp" alt="Energy Recovery" title='Energy Recovery'></img>
                <h1>Energy Recovery :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Wanted.webp" alt="Wanted" title='Wanted'></img>
                <h1>Wanted :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Special-Mission.webp" alt="Special Mission" title='Special Mission'></img>
                <h1>Special Mission :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Sealing-Attack.webp" alt="Sealing Attack" title='Sealing Attack'></img>
                <h1>Sealing Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Candlelight\Frenzy-Attack.webp" alt="Frenzy Attack" title='Frenzy Attack'></img>
                <h1>Frenzy Attack :
