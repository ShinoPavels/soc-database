    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Inc\Hasna\Hasna-Profile.webp" alt="Hasna" title='Hasna' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Lingering-Fragrance-Trait.webp" alt="Lingering Fragrance" title='Lingering Fragrance'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Corruption-and-Decay.webp" alt="Corruption and Decay" title='Corruption and Decay'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Hypnosis.webp" alt="Hypnosis" title='Hypnosis'></img>
                <h1>Hypnosis :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Fighting-Excitement.webp" alt="Fighting Excitement" title='Fighting Excitement'></img>
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Strong-Aroma-Shock.webp" alt="Strong Aroma Shock" title='Strong Aroma Shock'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Scented-Path.webp" alt="Scented Path" title='Scented Path'></img>
                <h1>Scented Path :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Wakaha-Cartilage.webp" alt="Wakaha Cartilage" title='Wakaha Cartilage'></img>
                <h1>Wakaha Cartilage :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Anger.webp" alt="Anger" title='Anger'></img>
                <h1>Anger :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Raid.webp" alt="Raid" title='Raid'></img>
                <h1>Raid :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Scent-of-a-Person.webp" alt="Scent of a Person" title='Scent of a Person'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Hypnotic-Strike.webp" alt="Hypnotic Strike" title='Hypnotic Strike'></img>
                <h1>Hypnotic Strike :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Eviscerated-Phantom.webp" alt="Eviscerated Phantom" title='Eviscerated Phantom'></img>
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Penetrates-Deeply.webp" alt="Penetrates Deeply" title='Penetrates Deeply'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Hasna\Life-Devouring.webp" alt="Life Devouring" title='Life Devouring'></img>
                <h1>Life Devouring :
