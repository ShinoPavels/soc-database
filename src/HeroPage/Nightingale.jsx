    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Gold-Out\Nightingale\Nightingale-Profile.webp" alt="Nightingale" title='Nightingale' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Volunteer-Trait.webp" alt="Volunteer" title='Volunteer'></img>
                <h1>Volunteer :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\First-Aid.webp" alt="First Aid" title='First Aid'></img>
                <h1>First Aid :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Bandage.webp" alt="Bandage" title='Bandage'></img>
                <h1>Bandage :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Weapon-Eroder.webp" alt="Weapon Eroder" title='Weapon Eroder'></img>
                <h1>Weapon Eroder :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Regenerate.webp" alt="Regenerate" title='Regenerate'></img>
                <h1>Regenerate :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Tranquilizer.webp" alt="Tranquilizer" title='Tranquilizer'></img>
                <h1>Tranquilizer :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Protection-of-Light.webp" alt="Protection of Light" title='Protection of Light'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Endure.webp" alt="Endure" title='Endure'></img>
                <h1>Endure :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Painkiller.webp" alt="Painkiller" title='Painkiller'></img>
                <h1>Painkiller :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Burning-Grenade.webp" alt="Burning Grenade" title='Burning Grenade'></img>
                <h1>Burning Grenade :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Merciful-Strike.webp" alt="Merciful Strike" title='Merciful Strike'></img>
                <h1>Merciful Strike :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Gold-Out\Nightingale\Silencing-Attack.webp" alt="Silencing Attack" title='Silencing Attack'></img>
                <h1>Silencing Attack :
