    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Inc\Layla\Layla-Profile.webp" alt="Layla" title='Layla' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Iris-Trait.webp" alt="Iris" title='Iris'></img>
                <h1>Iris :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Brutal-Smash.webp" alt="Brutal Smash" title='Brutal Smash'></img>
                <h1>Brutal Smash :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Co-Defense.webp" alt="Co-Defense" title='Co-Defense'></img>
                <h1>Co-Defense :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Police-Lasso.webp" alt="Police Lasso" title='Police Lasso'></img>
                <h1>Police Lasso :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Sheltered-Bay.webp" alt="Sheltered Bay" title='Sheltered Bay'></img>
                <h1>Sheltered Bay :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\We-Are-Together.webp" alt="We Are Together" title='We Are Together'></img>
                <h1>We Are Together :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Use-Waves.webp" alt="Use Waves" title='Use Waves'></img>
                <h1>Use Waves :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Front-Defense.webp" alt="Front Defense" title='Front Defense'></img>
                <h1>Front Defense :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Scarlet-Night.webp" alt="Scarlet Night" title='Scarlet Night'></img>
                <h1>Scarlet Night :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Cut-off-the-Clouds.webp" alt="Cut off the Clouds" title='Cut off the Clouds'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Dispelling-Strike.webp" alt="Dispelling Strike" title='Dispelling Strike'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Sword-in-the-Staff.webp" alt="Sword in the Staff" title='Sword in the Staff'></img>
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Battlefield-Walk.webp" alt="Battlefield Walk" title='Battlefield Walk'></img>
                <h1>Battlefield Walk :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Inc\Layla\Fighting-Stance.webp" alt="Fighting Stance" title='Fighting Stance'></img>
                <h1>Fighting Stance :
