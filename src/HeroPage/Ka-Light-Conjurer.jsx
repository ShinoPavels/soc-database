    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Ka-Light-Conjurer-Profile.webp" alt="Ka-Light-Conjurer" title='Ka-Light-Conjurer' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Love-Wings.webp" alt="Love Wings" title='Love Wings'></img>
                <h1>Love Wings :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Healing-Spell.webp" alt="Healing Spell" title='Healing Spell'></img>
                <h1>Healing Spell :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Purify.webp" alt="Purify" title='Purify'></img>
                <h1>Purify :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Sanction.webp" alt="Sanction" title='Sanction'></img>
                <h1>Sanction :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Regenerate.webp" alt="Regenerate" title='Regenerate'></img>
                <h1>Regenerate :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Damage-Enhancement.webp" alt="Damage Enhancement" title='Damage Enhancement'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Defender.webp" alt="Defender" title='Defender'></img>
                <h1>Defender :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Endure.webp" alt="Endure" title='Endure'></img>
                <h1>Endure :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Light-of-Purification.webp" alt="Light of Purification" title='Light of Purification'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Ka-Light-Conjurer\Legacy-of-Comrades.webp" alt="Legacy of Comrades" title='Legacy of Comrades'></img>
