    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Stormbreaker-Profile.webp" alt="Stormbreaker" title='Stormbreaker' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Divine-Storm-Axe.webp" alt="Divine Storm Axe" title='Divine Storm Axe'></img>
                <h1>Divine Storm Axe :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Tearing-Whirlwind.webp" alt="Tearing Whirlwind" title='Tearing Whirlwind'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Damage-Enhancement.webp" alt="Damage Enhancement" title='Damage Enhancement'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Toughness.webp" alt="Toughness" title='Toughness'></img>
                <h1>Toughness :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Inertial-Chop.webp" alt="Inertial Chop" title='Inertial Chop'></img>
                <h1>Inertial Chop :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Charge-Pursuit.webp" alt="Charge Pursuit" title='Charge Pursuit'></img>
                <h1>Charge Pursuit :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Storm-Counter.webp" alt="Storm Counter" title='Storm Counter'></img>
                <h1>Storm Counter :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Hardening.webp" alt="Hardening" title='Hardening'></img>
                <h1>Hardening :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Tiger-Charge.webp" alt="Tiger Charge" title='Tiger Charge'></img>
                <h1>Tiger Charge :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Execute.webp" alt="Execute" title='Execute'></img>
                <h1>Execute :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Charged-Attack.webp" alt="Charged Attack" title='Charged Attack'></img>
                <h1>Charged Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Stormbreaker\Powerful-Attack.webp" alt="Powerful Attack" title='Powerful Attack'></img>
                <h1>Powerful Attack :
