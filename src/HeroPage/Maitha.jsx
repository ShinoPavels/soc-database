    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Out\Maitha\Maitha-Profile.webp" alt="Maitha" title='Maitha' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Shield-of-Convallaria-Trait.webp" alt="Shield of Convallaria" title='Shield of Convallaria'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Leg-Slam.webp" alt="Leg Slam" title='Leg Slam'></img>
                <h1>Leg Slam :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Guard.webp" alt="Guard" title='Guard'></img>
                <h1>Guard :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Co-Defense.webp" alt="Co-Defense" title='Co-Defense'></img>
                <h1>Co-Defense :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Come-on,-everybody!.webp" alt="Come on, everybody!" title='Come on, everybody!'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Maithas-Charge.webp" alt="Maitha’s Charge" title='Maitha’s Charge'></img>
                <h1>Maitha’s Charge :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Endurance-Activation-S.webp" alt="Endurance Activation S" title='Endurance Activation S'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Block-Counter.webp" alt="Block Counter" title='Block Counter'></img>
                <h1>Block Counter :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Battle-Flag-of-Convallaria.webp" alt="Battle Flag of Convallaria" title='Battle Flag of Convallaria'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Bandage.webp" alt="Bandage" title='Bandage'></img>
                <h1>Bandage :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Armor-Piercing-Strike.webp" alt="Armor-Piercing Strike" title='Armor-Piercing Strike'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Powerful-Attack.webp" alt="Powerful Attack" title='Powerful Attack'></img>
                <h1>Powerful Attack :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Maithas-Combo.webp" alt="Maitha’s Combo" title='Maitha’s Combo'></img>
                <h1>Maitha’s Combo :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Maitha\Invulnerable.webp" alt="Invulnerable" title='Invulnerable'></img>
                <h1>Invulnerable :
