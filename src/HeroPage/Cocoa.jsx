    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Out\Cocoa\Cocoa-Profile.webp" alt="Cocoa" title='Cocoa' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Breakfast-Hapiness.webp" alt="Breakfast Happiness" title='Breakfast Happiness'></img>
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Try-the-Pan!.webp" alt="Try the Pan!" title='Try the Pan!'></img>
                <h1>Try the Pan! :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Mountain-Tribes.webp" alt="Mountain Tribes" title='Mountain Tribes'></img>
                <h1>Mountain Tribes :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Crushing-Bash.webp" alt="Crushing Bash" title='Crushing Bash'></img>
                <h1>Crushing Bash :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Potluck-Protector.webp" alt="Potluck Protector" title='Potluck Protector'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Cocoas-Treasure-Chest.webp" alt="Cocoa’s Treasure Chest" title='Cocoa’s Treasure Chest'></img>
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Defense-Ranged-Attack.webp" alt="Defense (Ranged Attack)" title='Defense (Ranged Attack)'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Stay-Strong!.webp" alt="Stay Strong!" title='Stay Strong!'></img>
                <h1>Stay Strong! :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Block-Enhancement.webp" alt="Block Enhancement" title='Block Enhancement'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Battle-Flag-of-Vlder.webp" alt="Battle Flag of Vlder" title='Battle Flag of Vlder'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\No-Turning-Round!.webp" alt="No Turning Round!" title='No Turning Round!'></img>
                <h1>No Turning Round! :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Armor-Piercing-Strike.webp" alt="Armor-Piercing Strike" title='Armor-Piercing Strike'></img>
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Invulnerable.webp" alt="Invulnerable" title='Invulnerable'></img>
                <h1>Invulnerable :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Cocoa\Iron-Pot-Stew.webp" alt="Iron Pot Stew" title='Iron Pot Stew'></img>
                <h1>Iron Pot Stew :
