    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Simona\Simona-Profile.webp" alt="Simona" title='Simona' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Winter-is-Coming-Trait.webp" alt="Winter is Coming" title='Winter is Coming'></img>
                <h1>Winter is Coming :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-Lance.webp" alt="Ice Lance" title='Ice Lance'></img>
                <h1>Ice Lance :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Icy-Blast.webp" alt="Icy Blast" title='Icy Blast'></img>
                <h1>Icy Blast :
                    <h2>(Magical DMG)
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-Cone.webp" alt="Ice Cone" title='Ice Cone'></img>
                <h1>Ice Cone :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-Assault.webp" alt="Ice Assault" title='Ice Assault'></img>
                <h1>Ice Assault :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-made-Armor.webp" alt="Ice-made Armor" title='Ice-made Armor'></img>
                <h1>Ice-made Armor :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Iceshards.webp" alt="Iceshards" title='Iceshards'></img>
                <h1>Iceshards :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Protection-of-Ice.webp" alt="Protection of Ice" title='Protection of Ice'></img>
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Flash-Freezing.webp" alt="Ice-made Sword" title='Ice-made Sword'></img>
                <h1>Ice-made Sword :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Battle-Flag-of-the-Union.webp" alt="Battle Flag of the Union" title='Battle Flag of the Union'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-made-Sword.webp" alt="Ice-made Sword" title='Ice-made Sword'></img>
                <h1>Ice-made Sword :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Ice-Attack.webp" alt="Ice Attack" title='Ice Attack'></img>
                <h1>Ice Attack :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Winter-Doomsday.webp" alt="Winter Doomsday" title='Winter Doomsday'></img>
                <h1>Winter Doomsday :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Simona\Will-to-Survive.webp" alt="Will to Survive" title='Will to Survive'></img>
                <h1>Will to Survive :
