    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\assets\Hero-Art-Out\Rawiyah\Rawiyah-Profile.webp" alt="Rawiyah" title='Rawiyah' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Bottom-Up-Trait.webp" alt="Bottoms Up" title='Bottoms Up'></img>
                <h1>Bottoms Up :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Gale-Breach.webp" alt="Gale Breach" title='Gale Breach'></img>
                <h1>Gale Breach :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Co-Attack.webp" alt="Co-Attack" title='Co-Attack'></img>
                <h1>Co-Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Toughness.webp" alt="Toughness" title='Toughness'></img>
                <h1>Toughness :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Piercing-Bash.webp" alt="Piercing Bash" title='Piercing Bash'></img>
                <h1>Piercing Bash :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Another-Pint!.webp" alt="Another Pint!" title='Another Pint!'></img>
                <h1>Another Pint! :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Screw-off!.webp" alt="Screw off!" title='Screw off!'></img>
                <h1>Screw off! :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Guardians-Heart.webp" alt="Guardian’s Heart" title='Guardian’s Heart'></img>
                <h1>Guardian’s Heart :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Mania-Smash.webp" alt="Mania Smash" title='Mania Smash'></img>
                <h1>Mania Smash :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Sword-of-Convallaria.webp" alt="Sword of Convallaria" title='Sword of Convallaria'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Fatal-Attack.webp" alt="Fatal Attack" title='Fatal Attack'></img>
                <h1>Fatal Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Dispelling-Strike.webp" alt="Dispelling Strike" title='Dispelling Strike'></img>
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Gale-Spin-Attack.webp" alt="Gale Spin Attack" title='Gale Spin Attack'></img>
                <h1>Gale Spin Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\assets\Hero-Art-Out\Rawiyah\Leagacy-of-Comrades.webp" alt="Legacy of Comrades" title='Legacy of Comrades'></img>
