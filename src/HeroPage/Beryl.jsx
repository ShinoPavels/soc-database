    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Out\Beryl\Beryl-Profile.webp" alt="Beryl" title='Beryl' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Im-a-Genius!-Trait.webp" alt="I’m a Genius!" title='I’m a Genius!'></img>
                <h1>I’m a Genius! :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Chuu-Chuu-Chuu!.webp" alt="Chuu Chuu Chuu!" title='Chuu Chuu Chuu!'></img>
                <h1>Chuu Chuu Chuu! :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Wall-of-Flame.webp" alt="Wall of Flame" title='Wall of Flame'></img>
                <h1>Wall of Flame :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Casual-Search.webp" alt="Casual Search" title='Casual Search'></img>
                <h1>Casual Search :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\ATK-Boost.png" alt="ATK Boost" title='ATK Boost'></img>
                <h1>ATK Boost :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\NRG-Restauration.webp" alt="NRG Restoration" title='NRG Restoration'></img>
                <h1>NRG Restoration :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Firewalking.webp" alt="Firewalking" title='Firewalking'></img>
                <h1>Firewalking :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Cutie.webp" alt="Cutie" title='Cutie'></img>
                <h1>Cutie :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Flaming-Meteor.webp" alt="Flaming Meteor" title='Flaming Meteor'></img>
                <h1>Flaming Meteor :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Try-This!.webp" alt="Try This!" title='Try This!'></img>
                <h1>Try This! :
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Scorching-Attack.webp" alt="Scorching-Attack" title='Scorching-Attack'></img>
                <h1>Scorching-Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\Bang!.webp" alt="Bang!" title='Bang!'></img>
                <h1>Bang! :
            ...
            <tr className='bg-gray-800'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\BOOOOOM!.webp" alt="BOOOOOM!" title='BOOOOOM!'></img>
                <h1>BOOOOOM! :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Out\Beryl\First-Aid.webp" alt="First Aid" title='First Aid'></img>
                <h1>First Aid :
