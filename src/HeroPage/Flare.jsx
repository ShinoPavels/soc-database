    ...
    <div className="text-white p-8">
      ...
      <div className="flex justify-center mb-8">
        ...
        <div className="w-64 h-85 bg-gray-700 flex items-center justify-center">
          ...
          <img src="\public\assets\Hero-Art-Gold-Out\Flare\Flare-Profile.webp" alt="Flare" title='Flare' className=''></img>
          ...
          <tbody>
            <tr className='bg-gray-800 align-left'>
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Dazzling-Light-Trait.webp" alt="Dazzling Light" title='Dazzling Light'></img>
                <h1>Dazzling Light :
              ...
              <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Cure-Blow.webp" alt="Cure Blow" title='Cure Blow'></img>
                <h1>Cure Blow :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Suppressive-Blow.webp" alt="Suppressive Blow" title='Suppressive Blow'></img>
                <h1>Suppressive Blow :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Blessing.webp" alt="Blessing" title='Blessing'></img>
                <h1>Blessing :
            ...
            <tr className='bg-gray-800  align left'>
            <td className=" px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Dedication.webp" alt="Dedication" title='Dedication'></img>
                <h1>Dedication :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Survivalist.webp" alt="Survivalist" title='Survivalist'></img>
                <h1>Survivalist :
            ...
            <tr className='align-left'>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Battlefield-Healing.webp" alt="Battlefield Healing" title='Battlefield Healing'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Front-Defense.webp" alt="Front Defense" title='Front Defense'></img>
                <h1>Front Defense :
            ...
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Battle-Flag-of-the-Union.webp" alt="Battle Flag of the Union" title='Battle Flag of the Union'></img>
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Thunderbolt-Assault.webp" alt="Thunderbolt Assault" title='Thunderbolt Assault'></img>
            ...
            <tr>
            <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Feverish-Attack.webp" alt="Feverish Attack" title='Feverish Attack'></img>
                <h1>Feverish Attack :
              ...
              <td className="px-4 py-2 flex items-center justify-left gap-2">
                <img src="\public\assets\Hero-Art-Gold-Out\Flare\Merciful-Strike.webp" alt="Merciful Strike" title='Merciful Strike'></img>
                <h1>Merciful Strike :
