  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Fancy-Hat-Cd.webp"
              alt="Fancy Hat"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A hat worn by performers. With its lowered brim, it helps performers concentrate on their performance.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Fancy Hat Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Gains [Immunity to Disrupt]. When [Healthy], M.DEF increases by %3.'],
                ['2-Star', 'Gains [Immunity to Disrupt]. When [Healthy], M.DEF increases by %6.'],
                ['3-Star', 'Gains [Immunity to Disrupt]. When [Healthy], M.DEF increases by %9.'],
                ['4-Star', 'Gains [Immunity to Disrupt]. When [Healthy], M.DEF increases by %12.'],
                ['5-Star', 'Gains [Immunity to Disrupt]. When [Healthy], M.DEF increases by %15.'],
