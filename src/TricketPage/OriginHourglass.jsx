  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Origin-Hourglass-Cd.webp"
              alt="Origin Hourglass"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A trinket developed by a long-forgotten deity who wished to reverse the flow of time. While this is impossible on a universal scale, it is relatively simple to manipulate the time which surrounds only oneself.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Origin Hourglass Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Increases P.ATK and M.ATK by 2%. Grants immunity against [▼Move] and [▼SPD].'],
                ['2-Star', 'Increases P.ATK and M.ATK by 3%. Grants immunity against [▼Move] and [▼SPD].'],
                ['3-Star', 'Increases P.ATK and M.ATK by 4%. Grants immunity against [▼Move] and [▼SPD].'],
                ['4-Star', 'Increases P.ATK and M.ATK by 6%. Grants immunity against [▼Move] and [▼SPD].'],
                ['5-Star', 'Increases P.ATK and M.ATK by 8%. Grants immunity against [▼Move] and [▼SPD].'],
...
export default OriginHourglass;
