  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Mysterious-Deflexion-Device-Cd.webp"
              alt="Mysterious Deflexion Device"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        The mysterious crystal constantly radiates the force of rejection, which invisibly causes the trajectory of the flying object to deviate.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Mysterious Deflexion Device Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Decreases the DMG from [Ranged Attacks] by 4%.'],
                ['2-Star', '	Decreases the DMG from [Ranged Attacks] by 6%.'],
                ['3-Star', '	Decreases the DMG from [Ranged Attacks] by 8%.'],
                ['4-Star', '	Decreases the DMG from [Ranged Attacks] by 10%.'],
                ['5-Star', '	Decreases the DMG from [Ranged Attacks] by 12%.'],
...
export default MysteriousDeflexionDevice;
