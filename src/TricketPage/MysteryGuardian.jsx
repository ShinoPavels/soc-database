  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Mystery-Guardian-Cd.webp"
              alt="Mystery Guardian"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Made of materials similar to the Calamity, you can vaguely feel the non-living force.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Mystery Guardian Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	When attacked from the [front], gains 5% bonus P.DEF and [🛇Defense Attribute Debuff].'],
                ['2-Star', '	When attacked from the [front], gains 10% bonus P.DEF and [🛇Defense Attribute Debuff].'],
                ['3-Star', '	When attacked from the [front], gains 15% bonus P.DEF and [🛇Defense Attribute Debuff].'],
                ['4-Star', '	When attacked from the [front], gains 20% bonus P.DEF and [🛇Defense Attribute Debuff].'],
                ['5-Star', '	When attacked from the [front], gains 25% bonus P.DEF and [🛇Defense Attribute Debuff].'],
...
export default MysteryGuardian;
