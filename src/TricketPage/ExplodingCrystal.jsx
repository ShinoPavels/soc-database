  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Exploding-Crystal-Cd.webp"
              alt="Exploding Crystal"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Some priests, after mastering the release of Luxite energy, attempt to push the output of the Luxite to its limit. Among them, the most skilled can maintain a critical state of the Luxite, preventing it from shattering. This expands the range of the Luxite Blessing influence.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Exploding Crystal Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '[Area Damage] increased by 6%.'],
                ['2-Star', '[Area Damage] increased by 8%.'],
                ['3-Star', '[Area Damage] increased by 10%.'],
                ['4-Star', '[Area Damage] increased by 12%.'],
                ['5-Star', '[Area Damage] increased by 15%.'],
...
export default ExplodingCrystal;
