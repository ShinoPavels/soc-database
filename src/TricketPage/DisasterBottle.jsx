  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Disaster-Bottle-Cd.webp"
              alt="Disaster Bottle"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Its very existence is a threat, and its power must be used with caution.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Disaster Bottle Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Active Skill: Catastrophe. [Instant]. Inflicts 1 random [Level 2 Attribute Debuffs] on the enemy, CD: 4 turns.'],
                ['2-Star', 'Active Skill: Catastrophe. [Instant]. Inflicts 1 random [Level 2 Attribute Debuffs] on the enemy, CD: 3 turns.'],
                ['3-Star', 'Active Skill: Catastrophe. [Instant]. Inflicts 2 random [Level 2 Attribute Debuffs] on the enemy, CD: 3 turns.'],
                ['4-Star', 'Active Skill: Catastrophe. [Instant]. Inflicts 2 random [Level 2 Attribute Debuffs] on the enemy, CD: 3 turns.'],
                ['5-Star', 'Active Skill: Catastrophe. [Instant]. Inflicts 2 random [Level 2 Attribute Debuffs] on the enemy, CD: 2 turns.'],
