  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Ink-Totem-Cd.webp"
              alt="Ink Totem"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A totem, resembling a toy, is drawn with Special ink to depict the Vlder healing mark, enhancing the healing effects of Luxite Blessing.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Ink Totem Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Healing effect increased by 5%.'],
                ['2-Star', '	Healing effect increased by 6%.'],
                ['3-Star', '	Healing effect increased by 7%.'],
                ['4-Star', '	Healing effect increased by 8%.'],
                ['5-Star', '	Healing effect increased by 10%.'],
