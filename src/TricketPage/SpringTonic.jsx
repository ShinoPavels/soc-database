  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Spring-Tonic-Cd.png"
              alt="Spring Tonic"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Made from wild-grown medicinal herbs and crystal-clear dew, this weapon can awaken the primal survival instincts of warriors and create a resonance between their lives.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Spring Tonic Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '[Instant]. Heals 30% HP. Can be used up to 1 time per battle.'],
                ['2-Star', '[Instant]. Heals 33% HP. Can be used up to 1 time per battle.'],
                ['3-Star', '[Instant]. Heals 36% HP. Can be used up to 1 time per battle.'],
                ['4-Star', '[Instant]. Heals 40% HP. Can be used up to 1 time per battle.'],
                ['5-Star', '[Instant]. Heals 45% HP. Can be used up to 1 time per battle.'],
