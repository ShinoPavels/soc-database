...
const HuntersIntuition = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Hunters-Intuition-Cd.webp"
              alt="Hunter's Intuition"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Hunter's Intuition Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	When [Alert] is triggered, deals 5% more DMG. Moreover, if a foe uses a skill within range of the [alert], it will also be triggered.'],
                ['2-Star', '	When [Alert] is triggered, deals 10% more DMG. Moreover, if a foe uses a skill within range of the [alert], it will also be triggered.'],
                ['3-Star', '	When [Alert] is triggered, deals 15% more DMG. Moreover, if a foe uses a skill within range of the [alert], it will also be triggered.'],
                ['4-Star', '	When [Alert] is triggered, deals 20% more DMG. Moreover, if a foe uses a skill within range of the [alert], it will also be triggered.'],
                ['5-Star', '	When [Alert] is triggered, deals 25% more DMG. Moreover, if a foe uses a skill within range of the [alert], it will also be triggered.'],
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
            ...
            <img src='\assets\Miniatures-Out\Iggy-Minia.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
...
export default HuntersIntuition;
