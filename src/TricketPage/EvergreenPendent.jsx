  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Evergreen-Pendent-Cd.webp"
              alt="Evergreen Pendent"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Made of a combination of semi-Luxite and semi-jade, this pendant often promotes a quick recovery from injuries and ailments.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Evergreen Pendent Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When healed, there is a 50% chance to gain 1 random [Level 2 Attribute Buff], which lasts for 2 turns.'],
                ['2-Star', 'When healed, there is a 60% chance to gain 1 random [Level 2 Attribute Buff], which lasts for 2 turns.'],
                ['3-Star', 'When healed, there is a 70% chance to gain 1 random [Level 2 Attribute Buff], which lasts for 2 turns.'],
                ['4-Star', 'When healed, there is a 80% chance to gain 1 random [Level 2 Attribute Buff], which lasts for 2 turns.'],
                ['5-Star', 'When healed, there is a 100% chance to gain 1 random [Level 2 Attribute Buff], which lasts for 2 turns.'],
...
export default EvergreenPendent;
