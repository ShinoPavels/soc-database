  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Coexist-Armor-Cd.webp"
              alt="Coexist Armor"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A thin layer of protective energy covers the surface of the skin. When you’re in good shape, you barely feel it.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Coexist Armor Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Damage taken decreases by %5 when [Healthy].'],
                ['2-Star', '	Damage taken decreases by %6 when [Healthy].'],
                ['3-Star', '	Damage taken decreases by %7 when [Healthy].'],
                ['4-Star', '	Damage taken decreases by %8 when [Healthy].'],
                ['5-Star', '	Damage taken decreases by %10 when [Healthy].'],
