  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Mist-Necklace-Cd.webp"
              alt="Mist Necklace"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        It is covered in a gray haze that appears ominous and intimidating, causing opponents to hesitate and back away.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Mist Necklace Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Before being actively attacked, inflicts 1 random [Level 1 Debuff] on the attacker for 2 turns. CD: 5 turns.'],
                ['2-Star', 'Before being actively attacked, inflicts 1 random [Level 1 Debuff] on the attacker for 2 turns. CD: 4 turns.'],
                ['3-Star', 'Before being actively attacked, inflicts 2 random [Level 1 Debuff] on the attacker for 2 turns. CD: 4 turns.'],
                ['4-Star', 'Before being actively attacked, inflicts 2 random [Level 1 Debuff] on the attacker for 2 turns. CD: 3 turns.'],
                ['5-Star', 'Before being actively attacked, inflicts 2 random [Level 1 Debuff] on the attacker for 2 turns. CD: 2 turns.'],
