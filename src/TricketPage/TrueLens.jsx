  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\True-Lens-Cd.webp"
              alt="True Lens"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A well-thought-out design created by a retired veteran. It is a complex device with a mechanism for the ballistic correction of most projectiles. While it is very useful, there is a risk of it becoming a crutch for rookie soldiers.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">True Lens Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Increases P.ATK by 1%. When attacking from [Highland], Crit increases by 12%.'],
                ['2-Star', 'Increases P.ATK by 2%. When attacking from [Highland], Crit increases by 14%.'],
                ['3-Star', 'Increases P.ATK by 3%. When attacking from [Highland], Crit increases by 16%.'],
                ['4-Star', 'Increases P.ATK by 4%. When attacking from [Highland], Crit increases by 18%.'],
                ['5-Star', 'Increases P.ATK by 5%. When attacking from [Highland], Crit increases by 20%.'],
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
            <img src='\assets\Miniatures-Out\Beryl-LilyWill.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
            <img src='\assets\Miniatures-Out\Beryl-Faycal.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
