  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Shroud-Of-Void-Cd.webp"
              alt="Shroud Of Void"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        The veil that covers the deep, makes it nearly impossible to penetrate by any kind of magical spell.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Shroud Of Void Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	[Instant] Decreases M.DMG taken by 50%, which can be activated up to 1 time. The effect lasts for 2 turns and can be used up to 1 time per battle.'],
                ['2-Star', '	[Instant] Decreases M.DMG taken by 60%, which can be activated up to 2 time. The effect lasts for 2 turns and can be used up to 1 time per battle.'],
                ['3-Star', '	[Instant] Decreases M.DMG taken by 60%, which can be activated up to 2 time. The effect lasts for 2 turns and can be used up to 1 time per battle.'],
                ['4-Star', '	[Instant] Decreases M.DMG taken by 70%, which can be activated up to 2 time. The effect lasts for 2 turns and can be used up to 1 time per battle.'],
                ['5-Star', '	[Instant] Decreases M.DMG taken by 70%, which can be activated up to 3 time. The effect lasts for 2 turns and can be used up to 1 time per battle.'],
