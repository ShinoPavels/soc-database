  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Rejection-Mask-Cd.webp"
              alt="Rejection Mask"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A serious-looking mask that can counteract a Significant portion of the effects of Luxite Blessing. It can also help experienced priests recall their master’s discipline.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Rejection Mask Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Magical Damage taken decreases by %20. Cooldown 5 turns.'],
                ['2-Star', '	Magical Damage taken decreases by %20. Cooldown 4 turns.'],
                ['3-Star', '	Magical Damage taken decreases by %20. Cooldown 3 turns.'],
                ['4-Star', '	Magical Damage taken decreases by %30. Cooldown 3 turns.'],
                ['5-Star', '	Magical Damage taken decreases by %30. Cooldown 2 turns.'],
