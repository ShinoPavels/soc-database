  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\The-Silent-Guard-Cd.webp"
              alt="The Silent Guard"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Endure, build up, and strike down the enemy in one hit-the principles one must abide by to become a formidable guard.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">The Silent Guard Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When actively attacked, DEF increases by 10%. The next attack deals 15% more damage.'],
                ['2-Star', 'When actively attacked, DEF increases by 20%. The next attack deals 15% more damage.'],
                ['3-Star', 'When actively attacked, DEF increases by 20%. The next attack deals 20% more damage.'],
                ['4-Star', 'When actively attacked, DEF increases by 30%. The next attack deals 20% more damage.'],
                ['5-Star', 'When actively attacked, DEF increases by 30%. The next attack deals 25% more damage.'],
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
            <img src='\assets\Miniatures-Out\Leonide-Minia.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
            <img src='\assets\Miniatures-Inc\Pamina-Minia.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
