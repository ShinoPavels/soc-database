...
const SkeletonSpear = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Skeleton-Spear-Cd.webp"
              alt="Skeleton Spear"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Skeleton Spear Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Increases Physical ATK by 2%. Before initiating a single-target attack, additionally, deals [Piercing DMG] equal to 10% Physical ATK to the target.'],
                ['2-Star', '	Increases Physical ATK by 4%. Before initiating a single-target attack, additionally, deals [Piercing DMG] equal to 10% Physical ATK to the target.'],
                ['3-Star', '	Increases Physical ATK by 6%. Before initiating a single-target attack, additionally, deals [Piercing DMG] equal to 10% Physical ATK to the target.'],
                ['4-Star', '	Increases Physical ATK by 8%. Before initiating a single-target attack, additionally, deals [Piercing DMG] equal to 10% Physical ATK to the target.'],
                ['5-Star', '	Increases Physical ATK by 10%. Before initiating a single-target attack, additionally, deals [Piercing DMG] equal to 10% Physical ATK to the target.'],
