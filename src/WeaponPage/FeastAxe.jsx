...
const FeastAxe = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Feast-Axe-Cd.webp"
              alt="Feast Axe"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Feast Axe Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'If the target’s HP percentage is lower than the character’s when attacking, increases ATK by 10%. The character recovers 20% HP when defeating an enemy. CD: 3 turns.'],
                ['2-Star', 'If the target’s HP percentage is lower than the character’s when attacking, increases ATK by 15%. The character recovers 20% HP when defeating an enemy. CD: 3 turns.'],
                ['3-Star', 'If the target’s HP percentage is lower than the character’s when attacking, increases ATK by 15%. The character recovers 20% HP when defeating an enemy. CD: 2 turns.'],
                ['4-Star', 'If the target’s HP percentage is lower than the character’s when attacking, increases ATK by 20%. The character recovers 20% HP when defeating an enemy. CD: 2 turns.'],
                ['5-Star', 'If the target’s HP percentage is lower than the character’s when attacking, increases ATK by 20%. The character recovers 35% HP when defeating an enemy. CD: 1 turns.'],
