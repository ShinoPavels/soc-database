  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Iria-Combat-Bow-Cd.webp"
              alt="Irian Combat Bow"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Made with lightweight yet sturdy materials, it can endure a certain amount of melee damage which makes it ideal for special operatives who might need to make a hasty retreat.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Irian Combat Bow Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Increases P.ATK by 1%. Deals %10 more DMG when not in the character’s turn.'],
                ['2-Star', '	Increases P.ATK by 2%. Deals %10 more DMG when not in the character’s turn.'],
                ['3-Star', '	Increases P.ATK by 3%. Deals %15 more DMG when not in the character’s turn.'],
                ['4-Star', '	Increases P.ATK by 4%. Deals %15 more DMG when not in the character’s turn.'],
                ['5-Star', '	Increases P.ATK by 5%. Deals %20 more DMG when not in the character’s turn.'],
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
            <img src='\assets\Miniatures-Out\Edda-Minia.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
