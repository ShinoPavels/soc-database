...
const StarrySkyHeritage = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Stary-Sky-Heritage-Cd.webp"
              alt="Starry Sky Heritage"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Starry Sky Heritage Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Increases HP by 5%. Grants bonus M.ATK equal to 3% HP at the start of the battle.'],
                ['2-Star', '	Increases HP by 5%. Grants bonus M.ATK equal to 4% HP at the start of the battle.'],
                ['3-Star', '	Increases HP by 5%. Grants bonus M.ATK equal to 5% HP at the start of the battle.'],
                ['4-Star', '	Increases HP by 5%. Grants bonus M.ATK equal to 6% HP at the start of the battle.'],
                ['5-Star', '	Increases HP by 10%. Grants bonus M.ATK equal to 6% HP at the start of the battle.'],
...
export default StarrySkyHeritage;
