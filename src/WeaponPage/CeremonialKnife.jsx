  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Ceremonial-Knife-Cd.webp"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        Decorated with exquisite patterns and precious gemstones, this ceremonial dagger appears to be a work of art rather than a weapon. However, in an unguarded moment, this dagger could also become a highly dangerous weapon, capable of delivering a powerful blow.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Ceremonial Knife Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When launching a [Back Attack], Crit increases by 12%'],
                ['2-Star', 'When launching a [Back Attack], Crit increases by 14%'],
                ['3-Star', 'When launching a [Back Attack], Crit increases by 16%'],
                ['4-Star', 'When launching a [Back Attack], Crit increases by 18%'],
                ['5-Star', 'When launching a [Back Attack], Crit increases by 20%'],
...
export default CeremonialKnife;
