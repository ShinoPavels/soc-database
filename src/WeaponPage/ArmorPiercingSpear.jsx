  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Armor-Piercing-Spear-Cd.webp"
              alt="Armor Piercing Spear"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        To penetrate through thick armors and Shields, the spearhead is infused with highly durable metal, Often catching overconfident armored enemies off guard.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Armor Piercing Spear Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When attacking enemies with a [Shield], ATK increases by 6%.'],
                ['2-Star', 'When attacking enemies with a [Shield], ATK increases by 8%.'],
                ['3-Star', 'When attacking enemies with a [Shield], ATK increases by 10%.'],
                ['4-Star', 'When attacking enemies with a [Shield], ATK increases by 12%.'],
                ['5-Star', 'When attacking enemies with a [Shield], ATK increases by 15%.'],
...
export default ArmorPiercingSpear;
