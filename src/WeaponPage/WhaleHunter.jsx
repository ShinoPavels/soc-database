...
const WhaleHunter = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Whale-Hunter-Cd.webp"
              alt="Whale Hunter"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Whale Hunter Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'After dealing DMG with single-target active attacks, gains a 50% chance to inflict [Infection] on the target, which can be triggered up to 1 time per round. The character deals 20% more DMG to the enemies with [infection].'],
                ['2-Star', 'After dealing DMG with single-target active attacks, gains a 60% chance to inflict [Infection] on the target, which can be triggered up to 1 time per round. The character deals 20% more DMG to the enemies with [infection].'],
                ['3-Star', 'After dealing DMG with single-target active attacks, gains a 70% chance to inflict [Infection] on the target, which can be triggered up to 1 time per round. The character deals 20% more DMG to the enemies with [infection].'],
                ['4-Star', 'After dealing DMG with single-target active attacks, gains a 80% chance to inflict [Infection] on the target, which can be triggered up to 1 time per round. The character deals 20% more DMG to the enemies with [infection].'],
                ['5-Star', 'After dealing DMG with single-target active attacks, gains a 100% chance to inflict [Infection] on the target, which can be triggered up to 1 time per round. The character deals 20% more DMG to the enemies with [infection].'],
