  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Beheading-Machete-Cd.png"
              alt="Beheading Machete"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        An almost circular, hooked blade designed for efficient beheading of enemies by the Hanged Men from high places, or for painfully suspending enemies in the air. It has also become a form of torture in the Papal States.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Beheading Machete Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	When attacking from [Highland], increases attack by 6%.'],
                ['2-Star', '	When attacking from [Highland], increases attack by 8%.'],
                ['3-Star', '	When attacking from [Highland], increases attack by 10%.'],
                ['4-Star', '	When attacking from [Highland], increases attack by 12%.'],
                ['5-Star', '	When attacking from [Highland], increases attack by 15%.'],
...
export default BeheadingMachete;
