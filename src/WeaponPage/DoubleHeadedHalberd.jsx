...
const DoubleHeadedHalberd = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Double-Headed-Halberd-Cd.webp"
              alt="Double-Headed Halberd"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Double-Headed Halberd Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Increases P.ATK by 5%. For each target hit when attacking, increases DMG by %3, up to %9.'],
                ['2-Star', 'Increases P.ATK by 5%. For each target hit when attacking, increases DMG by %4, up to %12.'],
                ['3-Star', 'Increases P.ATK by 5%. For each target hit when attacking, increases DMG by %5, up to %15.'],
                ['4-Star', 'Increases P.ATK by 5%. For each target hit when attacking, increases DMG by %6, up to %18.'],
                ['5-Star', 'Increases P.ATK by 5%. For each target hit when attacking, increases DMG by %8, up to %24.'],
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
            ...
            <img src='\assets\Miniatures-Out\Xavier-Minia.png' className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full object-cover shadow-lg"/>
...
export default DoubleHeadedHalberd;
