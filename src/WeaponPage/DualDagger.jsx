  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Dual-Dagger-Cd.webp"
              alt="Dual Dagger"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        With its uniquely designed gauntlet and a lightweight and highly durable blade, this sword empowers the wielder to easily parry many deadly attacks.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Dual Dagger Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When attacked from [front or side], P.DEF increases by 5%.'],
                ['2-Star', 'When attacked from [front or side], P.DEF increases by 10%.'],
                ['3-Star', 'When attacked from [front or side], P.DEF increases by 15%.'],
                ['4-Star', 'When attacked from [front or side], P.DEF increases by 20%.'],
                ['5-Star', 'When attacked from [front or side], P.DEF increases by 25%.'],
