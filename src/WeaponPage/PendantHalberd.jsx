...
const PendantHalberd = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Pendant-Halberd-Cd.webp"
              alt="Pendant Halberd"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Pendant Halberd Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'Increases HP by 2%. Before taking a single-target attack, gains 10% bonus ATK and DEF.'],
                ['2-Star', 'Increases HP by 4%. Before taking a single-target attack, gains 10% bonus ATK and DEF.'],
                ['3-Star', 'Increases HP by 6%. Before taking a single-target attack, gains 10% bonus ATK and DEF.'],
                ['4-Star', 'Increases HP by 8%. Before taking a single-target attack, gains 10% bonus ATK and DEF.'],
                ['5-Star', 'Increases HP by 10%. Before taking a single-target attack, gains 10% bonus ATK and DEF.'],
