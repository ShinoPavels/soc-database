  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Skeleton-Staff-Cd.webp"
              alt="Skeleton Staff"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        The gloomy yet stylish bone wand is the last legacy of a prominent Sanctuary Priest in the Papal States. As long as its power is not depleted, the user’s spirit will endure even after the body perishes.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Skeleton Staff Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', '	Increases HP by 2%. Recovers 1 Energy when an ally is defeated in battle. The effect can be triggered up to 1 time per round.'],
                ['2-Star', '	Increases HP by 4%. Recovers 1 Energy when an ally is defeated in battle. The effect can be triggered up to 1 time per round.'],
                ['3-Star', '	Increases HP by 6%. Recovers 1 Energy when an ally is defeated in battle. The effect can be triggered up to 1 time per round.'],
                ['4-Star', '	Increases HP by 8%. Recovers 1 Energy when an ally is defeated in battle. The effect can be triggered up to 1 time per round.'],
                ['5-Star', '	Increases HP by 10%. Recovers 1 Energy when an ally is defeated in battle. The effect can be triggered up to 1 time per round.'],
