  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Balancer-Heavy-Axe-Cd.webp"
              alt="Balancer Heavy Axe"
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        ...
        A finely crafted hatchet with a wonderful balance that harnesses the full strength of its wielder’s body, making its weight almost imperceptible. However, this feature is not so friendly once the wielder is injured.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Balancer Heavy Axe Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When [Healthy], ATK increases by 6%.'],
                ['2-Star', 'When [Healthy], ATK increases by 7%.'],
                ['3-Star', 'When [Healthy], ATK increases by 8%.'],
                ['4-Star', 'When [Healthy], ATK increases by 10%.'],
                ['5-Star', 'When [Healthy], ATK increases by 12%.'],
...
export default BalancerHeavyAxe;
