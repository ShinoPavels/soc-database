...
const DenialHammer = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Legendary\Denial-Hammer-Cd.webp"
              alt="Denial Hammer"
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Denial Hammer Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'When charging, deals 5% more DMG. If targets who have lower HP than the character are knocked back, pushes them back by 1 more tile.'],
                ['2-Star', 'When charging, deals 10% more DMG. If targets who have lower HP than the character are knocked back, pushes them back by 1 more tile.'],
                ['3-Star', 'When charging, deals 15% more DMG. If targets who have lower HP than the character are knocked back, pushes them back by 1 more tile.'],
                ['4-Star', 'When charging, deals 20% more DMG. If targets who have lower HP than the character are knocked back, pushes them back by 1 more tile.'],
                ['5-Star', 'When charging, deals 25% more DMG. If targets who have lower HP than the character are knocked back, pushes them back by 1 more tile.'],
