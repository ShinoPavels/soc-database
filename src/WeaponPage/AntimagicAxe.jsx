      ...
      <div className="lg:flex lg:items-start lg:space-x-8 mb-10">
        ...
        <div className="flex justify-center lg:w-1/3 mb-8 lg:mb-0">
          <div className="relative">
            {/* Responsive Image */}
            <img
              src="\assets\Gear-Gold-or-Below\Antimagic-Axe-Cd.webp"
              alt="Antimagic Axe"
...
An axe engraved with runes that absorb magic, created to help infantry soldiers survive against divine spells. It has since become a symbol of fear for many rookie conjurers.
      ...
      {/* Skill Section */}
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-10">
        <h2 className="text-3xl font-bold text-white mb-6">Antimagic Axe Skill</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-transparent table-auto text-left text-white border-separate border-spacing-y-2">
            <thead>
            ...
            <tbody>
              {[
                ['1-Star', 'After actively attacking and dealing DMG, has a 60% chance to dispel 1 [Buff] on the target. CD: 2 turns.'],
                ['2-Star', 'After actively attacking and dealing DMG, has a 80% chance to dispel 1 [Buff] on the target. CD: 2 turns.'],
                ['3-Star', 'After actively attacking and dealing DMG, has a 100% chance to dispel 1 [Buff] on the target. CD: 2 turns.'],
                ['4-Star', 'After actively attacking and dealing DMG, has a 60% chance to dispel 1 [Buff] on the target. CD: 1 turns.'],
                ['5-Star', 'After actively attacking and dealing DMG, has a 60% chance to dispel 2 [Buff] on the target. CD: 1 turns.'],
